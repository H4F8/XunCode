...
**1.3.** Правообладатель Приложения — XunKal1 (H4F8).

## 2. Ранняя стадия разработки

**2.1.** Приложение находится на ранней стадии разработки. Отдельные функции могут работать нестабильно или изменяться без предварительного уведомления.

**2.2.** Пользователь осознаёт экспериментальный характер Приложения и использует его на собственный риск.

## 3. Лицензия и открытый код

**3.1.** Приложение распространяется свободно как программное обеспечение с открытым исходным кодом по лицензии **Apache License 2.0**.

**3.2.** Пользователь вправе использовать, изучать, изменять и распространять Приложение на условиях лицензии Apache-2.0. Полный текст лицензии доступен в репозитории Приложения (файл LICENSE).

**3.3.** Соглашение не отменяет и не заменяет условия лицензии Apache-2.0, а дополняет их в части практического использования Приложения.

## 4. Правила использования

**4.1.** Приложение предназначено для написания, редактирования и выполнения программного кода, работы с файлами проектов и терминалом.

**4.2.** Пользователь использует Приложение исключительно в целях, не запрещённых законодательством его страны.

**4.3.** Запрещается использовать Приложение для создания, распространения или исполнения вредоносного программного обеспечения, нарушения прав третьих лиц и совершения противоправных действий.

**4.4.** Вся ответственность за созданный, изменённый или исполненный Пользователем код и команды лежит исключительно на Пользователе.

## 5. Терминал и пользовательская среда Linux

**5.1.** Приложение включает терминал и опциональную пользовательскую среду Alpine Linux на базе proot, работающую в пространстве пользователя без root-доступа.

**5.2.** Все команды, выполняемые в терминале (в том числе через плагины), исполняются от имени Пользователя. Правообладатель не контролирует содержание выполняемых команд.

**5.3.** Функция очистки кэша среды удаляет файлы пользовательского окружения. Перед её использованием Пользователь обязан сохранить важные данные проекта.

## 6. Плагины сторонних разработчиков

**6.1.** Приложение позволяет устанавливать плагины из внешних источников (GitHub-репозитории, маркетплейс). Плагины создаются третьими лицами и не являются частью Приложения.

**6.2.** Несмотря на наличие песочницы, Правообладатель не гарантирует корректность и безопасность сторонних плагинов. Установка и использование плагинов осуществляются Пользователем на свой риск.

**6.3.** Претензии по работе сторонних плагинов направляются их авторам.

## 7. Данные пользователя и резервные копии

**7.1.** Файлы проектов создаются, хранятся и изменяются локально на устройстве Пользователя.

**7.2.** Пользователь самостоятельно обеспечивает резервное копирование важных данных. Правообладатель не несёт ответственности за утрату файлов, данных или исходного кода вследствие любых обстоятельств, включая сбои Приложения, действия Пользователя, работу сторонних плагинов или обновление программной среды.

## 8. Конфиденциальность

**8.1.** Приложение не собирает персональные данные Пользователя, не содержит рекламы и трекеров.

**8.2.** Приложение выполняет сетевые запросы исключительно к сервисам GitHub (проверка обновлений, загрузка плагинов), к адресам сред разработки, указанным самим Пользователем, а также к магазину приложений при отправке отзыва.

**8.3.** Настройки Приложения хранятся локально на устройстве Пользователя.

**8.4.** Текст сообщения о проблеме, добровольно отправленный Пользователем через встроенную форму, передаётся Правообладателю вместе с техническими сведениями о версии Приложения и операционной системе. Пользователь может отказаться от отправки в любой момент.

## 9. Обновления

**9.1.** Приложение проверяет наличие обновлений через официальный репозиторий GitHub Правообладателя.

**9.2.** Обычные обновления устанавливаются добровольно. Критические обновления безопасности могут блокировать работу Приложения до их установки — это защищает данные и устройство Пользователя.

## 10. Обратная связь

**10.1.** Пользователь вправе сообщать о проблемах и предлагать улучшения через встроенную форму обратной связи либо через отзывы в магазине приложений, где распространяется Приложение.

**10.2.** Правообладатель не гарантирует индивидуальные ответы на каждое обращение, однако рассматривает все поступающие сообщения при развитии Приложения.

## 11. Отказ от гарантий

**11.1.** Приложение предоставляется «КАК ЕСТЬ» («AS IS»). Правообладатель не предоставляет никаких гарантий, явных или подразумеваемых, включая гарантии пригодности для конкретных целей и отсутствия нарушений прав третьих лиц.

**11.2.** Правообладатель не гарантирует непрерывную и безошибочную работу Приложения.

## 12. Ограничение ответственности

**12.1.** Правообладатель не несёт ответственности за любой прямой или косвенный ущерб, включая упущенную выгоду, потерю данных, потерю прибыли, возникшие в результате использования или невозможности использования Приложения.

**12.2.** Ответственность Правообладателя ограничена суммой, фактически уплаченной Пользователем за Приложение (0 рублей / 0 долларов США, поскольку Приложение бесплатное).

## 13. Изменения условий

**13.1.** Правообладатель вправе изменять условия настоящего Соглашения. Актуальная редакция публикуется в Приложении и/или в официальном репозитории GitHub.

**13.2.** Продолжение использования Приложения после публикации изменений означает согласие Пользователя с новой редакцией Соглашения.
